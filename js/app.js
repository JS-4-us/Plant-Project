...
var inDoor = ['Aloe Vera Rock', 'Euphorbia Trigona', 'Fernwood Sansevieria', 'Gasteria Flow', 'Sansevieria Cylindrica Handshake', 'Sansevieria Laurentii Dwarf', 'Succulentmix', 'Till andsia CurlySlim', 'Alocasia Culcullata', 'Alocasia Zebrina', 'Begonia Maculata Wightii', 'Ctenanthe', 'Cycas Revoluta', 'Ficus Bonsai', 'Potted Livistonia Rotundifoliadouble', 'Rhapisexcelsa', 'Anthurium Mix', 'Guzmania Mix', 'Oncidium Orchid', 'Phalaenopsis Orchid -Purple', 'Phalaenopsis Orchid White', 'Spathiphyllum\'Peace Lily\'', 'Strelitzia Reginae', 'Vriesea Mix'];
